declare namespace Form.knowledgearticleincident.Main {
    ...
    interface KnowledgeArticleIncidentForInteractiveExperience extends XrmBase.PageBase<KnowledgeArticleIncidentForInteractiveExperience.Attributes, KnowledgeArticleIncidentForInteractiveExperience.Tabs, KnowledgeArticleIncidentForInteractiveExperience.Controls> {
