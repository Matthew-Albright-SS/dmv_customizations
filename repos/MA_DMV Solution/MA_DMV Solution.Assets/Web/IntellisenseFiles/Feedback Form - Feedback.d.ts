declare namespace Form.feedback.Main {
    namespace Feedback {
        namespace Tabs {
            interface General extends XrmBase.SectionCollectionBase {
                get(name: "feedback Details"): XrmBase.PageSection;
                get(name: "feedback Contacts"): XrmBase.PageSection;
    ...
    interface Feedback extends XrmBase.PageBase<Feedback.Attributes, Feedback.Tabs, Feedback.Controls> {
