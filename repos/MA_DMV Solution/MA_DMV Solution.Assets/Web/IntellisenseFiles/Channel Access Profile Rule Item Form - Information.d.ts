declare namespace Form.channelaccessprofileruleitem.Main {
    namespace Information {
        ...
        interface Attributes extends XrmBase.AttributeCollectionBase {
            get(name: "associatedchannelaccessprofile"): XrmBase.LookupAttribute<"channelaccessprofile">;
        ...
        interface Controls extends XrmBase.ControlCollectionBase {
            get(name: "associatedProfile"): XrmBase.LookupControl<"channelaccessprofile">;
    ...
    interface Information extends XrmBase.PageBase<Information.Attributes, Information.Tabs, Information.Controls> {
        ...
        getAttribute(attributeName: "associatedchannelaccessprofile"): XrmBase.LookupAttribute<"channelaccessprofile">;
        getAttribute(attributeName: string): undefined;
        getControl(controlName: "name"): XrmBase.StringControl;
        getControl(controlName: "description"): XrmBase.StringControl;
        getControl(controlName: "associatedProfile"): XrmBase.LookupControl<"channelaccessprofile">;
