declare namespace Form.entitlementtemplatechannel.Main {
    namespace EntitlementTemplateChannel {
        namespace Tabs {
            interface General extends XrmBase.SectionCollectionBase {
                get(name: "entitlementtemplatechannelinformation"): XrmBase.PageSection;
    ...
    interface EntitlementTemplateChannel extends XrmBase.PageBase<EntitlementTemplateChannel.Attributes, EntitlementTemplateChannel.Tabs, EntitlementTemplateChannel.Controls> {
