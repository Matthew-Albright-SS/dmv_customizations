declare namespace Form.msdyn_agreement.Main {
    namespace Agreement {
        namespace Tabs {
            interface _4c8bef3be06c4411b31259f180556e4d extends XrmBase.SectionCollectionBase {
                get(name: "{3568be1d-2a14-40a9-b8cd-b04e3806e3e2}"): XrmBase.PageSection;
                get(name: "tab_1_section_2"): XrmBase.PageSection;
                get(name: "tab_4_section_1"): XrmBase.PageSection;
                get(name: "{4c8bef3b-e06c-4411-b312-59f180556e4d}_section_2"): XrmBase.PageSection;
        ...
        interface Controls extends XrmBase.ControlCollectionBase {
            ...
            get(name: "ContractLines"): XrmBase.SubGridControl<"salesorderdetail">;
            ...
            get(name: "QuotesLinesGrid"): XrmBase.SubGridControl<"quotedetail">;
        ...
        interface Tabs extends XrmBase.TabCollectionBase {
            get(name: "{4c8bef3b-e06c-4411-b312-59f180556e4d}"): XrmBase.PageTab<Tabs._4c8bef3be06c4411b31259f180556e4d>;
    ...
    interface Agreement extends XrmBase.PageBase<Agreement.Attributes, Agreement.Tabs, Agreement.Controls> {
        ...
        getControl(controlName: "ContractLines"): XrmBase.SubGridControl<"salesorderdetail">;
        getControl(controlName: "QuotesLinesGrid"): XrmBase.SubGridControl<"quotedetail">;
