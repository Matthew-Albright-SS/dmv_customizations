declare namespace Form.socialactivity.Main {
    namespace SocialActivityForInteractiveExperience {
        ...
        interface Attributes extends XrmBase.AttributeCollectionBase {
            ...
            get(name: "postedon"): XrmBase.DateAttribute;
            get(name: "postfromprofileid"): XrmBase.LookupAttribute<"socialprofile">;
            get(name: "postmessagetype"): XrmBase.OptionSetAttribute<socialactivity_postmessagetype>;
            get(name: "posttoprofileid"): XrmBase.StringAttribute;
            get(name: "posturl"): XrmBase.StringAttribute;
        ...
        interface Controls extends XrmBase.ControlCollectionBase {
            ...
            get(name: "postedon"): XrmBase.DateControl;
            get(name: "postfromprofileid"): XrmBase.LookupControl<"socialprofile">;
            get(name: "postmessagetype"): XrmBase.OptionSetControl<socialactivity_postmessagetype>;
            get(name: "posttoprofileid"): XrmBase.StringControl;
            get(name: "posturl"): XrmBase.StringControl;
    ...
    interface SocialActivityForInteractiveExperience extends XrmBase.PageBase<SocialActivityForInteractiveExperience.Attributes, SocialActivityForInteractiveExperience.Tabs, SocialActivityForInteractiveExperience.Controls> {
        ...
        getAttribute(attributeName: "postfromprofileid"): XrmBase.LookupAttribute<"socialprofile">;
        getAttribute(attributeName: "postedon"): XrmBase.DateAttribute;
        getAttribute(attributeName: "posttoprofileid"): XrmBase.StringAttribute;
        getAttribute(attributeName: "postmessagetype"): XrmBase.OptionSetAttribute<socialactivity_postmessagetype>;
        getAttribute(attributeName: "posturl"): XrmBase.StringAttribute;
        ...
        getControl(controlName: "postfromprofileid"): XrmBase.LookupControl<"socialprofile">;
        getControl(controlName: "postedon"): XrmBase.DateControl;
        getControl(controlName: "posttoprofileid"): XrmBase.StringControl;
        getControl(controlName: "postmessagetype"): XrmBase.OptionSetControl<socialactivity_postmessagetype>;
        getControl(controlName: "posturl"): XrmBase.StringControl;
