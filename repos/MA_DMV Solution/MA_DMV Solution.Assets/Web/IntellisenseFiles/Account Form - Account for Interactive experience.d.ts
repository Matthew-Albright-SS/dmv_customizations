declare namespace Form.account.Main {
    namespace AccountForInteractiveExperience {
        namespace Tabs {
            interface SUMMARYTAB extends XrmBase.SectionCollectionBase {
                ...
                get(name: "ref_pan_SUMMARY_TAB_section_6"): XrmBase.PageSection;
        ...
        interface Controls extends XrmBase.ControlCollectionBase {
            get(name: "accountcasessgrid"): XrmBase.BaseControl;
            get(name: "accountopportunitiesgrid"): XrmBase.BaseControl;
            ...
            get(name: "Contacts"): XrmBase.BaseControl;
    ...
    interface AccountForInteractiveExperience extends XrmBase.PageBase<AccountForInteractiveExperience.Attributes, AccountForInteractiveExperience.Tabs, AccountForInteractiveExperience.Controls> {
        ...
        getControl(controlName: "Contacts"): XrmBase.BaseControl;
        getControl(controlName: "accountopportunitiesgrid"): XrmBase.BaseControl;
        getControl(controlName: "accountcasessgrid"): XrmBase.BaseControl;
