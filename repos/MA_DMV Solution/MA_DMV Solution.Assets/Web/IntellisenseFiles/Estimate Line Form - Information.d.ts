declare namespace Form.msdyn_estimateline.Main {
    namespace Information {
        namespace Tabs {
            interface d8123bfe186b4faf8ece48dd82a8dce9 extends XrmBase.SectionCollectionBase {
                get(name: "DateGroup"): XrmBase.PageSection;
                get(name: "PartyGroup"): XrmBase.PageSection;
                get(name: "ActivityGroup"): XrmBase.PageSection;
                get(name: "ProductResourceGroup"): XrmBase.PageSection;
                get(name: "QuantityGroup"): XrmBase.PageSection;
                get(name: "AmountGroup"): XrmBase.PageSection;
                get(name: "BillingGroup"): XrmBase.PageSection;
        ...
        interface Tabs extends XrmBase.TabCollectionBase {
            get(name: "{d8123bfe-186b-4faf-8ece-48dd82a8dce9}"): XrmBase.PageTab<Tabs.d8123bfe186b4faf8ece48dd82a8dce9>;
            get(name: string): undefined;
