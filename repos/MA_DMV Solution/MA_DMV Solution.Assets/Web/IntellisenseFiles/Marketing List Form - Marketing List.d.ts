declare namespace Form.list.Main {
    namespace MarketingList {
        namespace Tabs {
            ...
            interface Members extends XrmBase.SectionCollectionBase {
        ...
        interface Tabs extends XrmBase.TabCollectionBase {
            ...
            get(name: "members"): XrmBase.PageTab<Tabs.Members>;
    ...
    interface MarketingList extends XrmBase.PageBase<MarketingList.Attributes, MarketingList.Tabs, MarketingList.Controls> {
