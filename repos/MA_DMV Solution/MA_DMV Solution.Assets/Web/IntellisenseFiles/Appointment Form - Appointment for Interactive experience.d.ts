declare namespace Form.appointment.Main {
    namespace AppointmentForInteractiveExperience {
        namespace Tabs {
            interface Tab5 extends XrmBase.SectionCollectionBase {
                get(name: "tab_5_section_5"): XrmBase.PageSection;
    ...
    interface AppointmentForInteractiveExperience extends XrmBase.PageBase<AppointmentForInteractiveExperience.Attributes, AppointmentForInteractiveExperience.Tabs, AppointmentForInteractiveExperience.Controls> {
