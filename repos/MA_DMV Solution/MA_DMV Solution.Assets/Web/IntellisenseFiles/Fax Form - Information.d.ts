declare namespace Form.fax.Main {
    namespace Information {
        namespace Tabs {
            interface Fax extends XrmBase.SectionCollectionBase {
                get(name: "general information"): XrmBase.PageSection;
                get(name: "fax description"): XrmBase.PageSection;
                get(name: "fax details"): XrmBase.PageSection;
        ...
        interface Attributes extends XrmBase.AttributeCollectionBase {
            ...
            get(name: "coverpagename"): XrmBase.StringAttribute;
            get(name: "description"): XrmBase.StringAttribute;
            get(name: "directioncode"): XrmBase.OptionSetAttribute<boolean>;
            get(name: "faxnumber"): XrmBase.StringAttribute;
            get(name: "from"): XrmBase.LookupAttribute<"account" | "contact" | "lead" | "queue" | "systemuser">;
            get(name: "ownerid"): XrmBase.LookupAttribute<"systemuser" | "team">;
            get(name: "prioritycode"): XrmBase.OptionSetAttribute<fax_prioritycode>;
            ...
            get(name: "to"): XrmBase.LookupAttribute<"account" | "contact" | "lead" | "queue" | "systemuser">;
            get(name: string): undefined;
        ...
        interface Controls extends XrmBase.ControlCollectionBase {
            ...
            get(name: "coverpagename"): XrmBase.StringControl;
            get(name: "description"): XrmBase.StringControl;
            get(name: "directioncode"): XrmBase.OptionSetControl<any>;
            get(name: "faxnumber"): XrmBase.StringControl;
            get(name: "from"): XrmBase.LookupControl<"account" | "contact" | "lead" | "queue" | "systemuser">;
            get(name: "notescontrol"): XrmBase.StringControl;
            get(name: "ownerid"): XrmBase.LookupControl<"systemuser" | "team">;
            get(name: "prioritycode"): XrmBase.OptionSetControl<fax_prioritycode>;
            ...
            get(name: "to"): XrmBase.LookupControl<"account" | "contact" | "lead" | "queue" | "systemuser">;
            get(name: string): undefined;
        ...
        interface Tabs extends XrmBase.TabCollectionBase {
            get(name: "fax"): XrmBase.PageTab<Tabs.Fax>;
    ...
    interface Information extends XrmBase.PageBase<Information.Attributes, Information.Tabs, Information.Controls> {
        getAttribute(attributeName: "from"): XrmBase.LookupAttribute<"account" | "contact" | "lead" | "queue" | "systemuser">;
        getAttribute(attributeName: "faxnumber"): XrmBase.StringAttribute;
        getAttribute(attributeName: "to"): XrmBase.LookupAttribute<"account" | "contact" | "lead" | "queue" | "systemuser">;
        ...
        getAttribute(attributeName: "prioritycode"): XrmBase.OptionSetAttribute<fax_prioritycode>;
        getAttribute(attributeName: "scheduledend"): XrmBase.DateAttribute;
        getAttribute(attributeName: "coverpagename"): XrmBase.StringAttribute;
        ...
        getControl(controlName: "from"): XrmBase.LookupControl<"account" | "contact" | "lead" | "queue" | "systemuser">;
        getControl(controlName: "faxnumber"): XrmBase.StringControl;
        getControl(controlName: "to"): XrmBase.LookupControl<"account" | "contact" | "lead" | "queue" | "systemuser">;
        ...
        getControl(controlName: "prioritycode"): XrmBase.OptionSetControl<fax_prioritycode>;
        getControl(controlName: "scheduledend"): XrmBase.DateControl;
        getControl(controlName: "coverpagename"): XrmBase.StringControl;
