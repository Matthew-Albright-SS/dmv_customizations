declare namespace XrmBase {
    /**
     * Enum which corresponds to the values of XrmBase.Page.ui.getFormType()
     */
    const enum FormType {
        Undefined = 0,
        Create = 1,
    ...
    /**
     * Interface for an entity reference for the XrmBase.Page context.
     */
    ...
    interface Attribute<T> {
        ...
        /**
         * Get a reference to the XrmBase.Page.data.entity object that is the parent to all attributes.
         */
         ...
         */
        addOnChange(functionRef: (context?: ExecutionContext<any>) => any): void;
    ...
    interface LookupAttribute<T extends string> extends Attribute<EntityReference<T>[]> {
        ...
        /**
         * Returns true if this is a party list
         */
    ...
    interface Control<T extends Attribute<any>> extends BaseControl {
        /**
    ...
    interface ViewSelector {
         ...
         */
        getCurrentView(): EntityReference<string>;
         ...
         */
        setCurrentView(reference: EntityReference<string>): void;
    }
    ...
    interface PageEntity<T extends AttributeCollectionBase> {
         ...
         */
        addOnSave(functionRef: (context?: ExecutionContext<any>) => any): void;
    ...
    interface ExecutionContext<T extends PageBase<AttributeCollectionBase, TabCollectionBase, ControlCollectionBase>> {
        /**
    ...
    interface PageTab<T extends SectionCollectionBase> {
        ...
        /**
         * Returns the XrmBase.Page.ui object.
         */
    ...
    interface UiModule<T extends TabCollectionBase, U extends ControlCollectionBase> {
         ...
         * Matches the values found in the XrmBase.FormType enum.
         */
    ...
    /**
     * Interface for the base of an XrmBase.Page
     */
    ...
    /**
     * Interface for a generic XrmBase.Page
     */
    interface BasicPage extends PageBase<AttributeCollection, TabCollection, ControlCollection> {
         ...
         * Generic getControl
         */
        getControl(ctrlName: string): AnyControl | undefined;
    }

    var Utility: Utility;

    /**
     * Interface for a Lookup which is used by some XrmBase.Utility functions.
     */
    interface Lookup {
        /**
...
type BaseXrm = typeof XrmBase;
/**
 * Client-side xRM object model.
 */
interface XrmBase<T extends XrmBase.PageBase<XrmBase.AttributeCollectionBase, XrmBase.TabCollectionBase, XrmBase.ControlCollectionBase>> extends BaseXrm {
    /**
     * Various utility functions can be found here.
     */
    Utility: XrmBase.Utility;
}
...
declare namespace XrmBase {
    var Page: PageBase<AttributeCollectionBase, TabCollectionBase, ControlCollectionBase>;
	/**
     * Interface for the base of an XrmBase.Page
     */
    interface PageBase<T extends AttributeCollectionBase, U extends TabCollectionBase, V extends ControlCollectionBase> {
    ...
    /**
     * Interface for the XrmBase.Utility functionality.
     */
    interface Utility {
...
interface XrmBase<T extends XrmBase.PageBase<XrmBase.AttributeCollectionBase, XrmBase.TabCollectionBase, XrmBase.ControlCollectionBase>> extends BaseXrm {
    /**
     * The XrmBase.Page object model, which contains data about the current page.
     */
    Page: T;
}
...
declare namespace XrmBase {
    interface SubGridControl<T extends string> extends BaseControl {
         ...
         */
        addOnLoad(functionRef: (context?: ExecutionContext<any>) => any): void;
    ...
    interface GridEntity<T extends string> {
         ...
         */
        getEntityReference(): EntityReference<T>;
...
declare namespace XrmBase {
    ...
    interface ProcessModule {
         ...
         */
        addOnStageChange(handler: (context?: ExecutionContext<any>) => any): void;
         ...
         */
        removeOnStageChange(handler: (context?: ExecutionContext<any>) => any): void;
         ...
         * @param handler The function will be added to the bottom of the event handler pipeline.
         */
        addOnStageSelected(handler: (context?: ExecutionContext<any>) => any): void;
         ...
         */
        removeOnStageSelected(handler: (context?: ExecutionContext<any>) => any): void;
...
declare namespace XrmBase {
    ...
    interface ProcessModule {
         ...
         *                event handler.
         */
        addOnProcessStatusChange(handler: (context?: ExecutionContext<any>) => any): void;
        ...
        */
        removeOnProcessStatusChange(handler: (context?: ExecutionContext<any>) => any): void;
    }
}
...
declare namespace XrmBase {
    interface StringControl extends Control<Attribute<string>> {
         ...
         */
        addOnKeyPress(functionRef: (context?: ExecutionContext<any>) => any): void;
...
declare namespace XrmBase {
    ...
    */
    interface Navigation {
		...
		*/
        openFile(file: File, openFileOptions?: OpenFileOptions);
    ...
    */
    interface ExecutionContext<T extends XrmBase.PageBase<XrmBase.AttributeCollectionBase, XrmBase.TabCollectionBase, XrmBase.ControlCollectionBase>> {
        getUrl(): string;
    ...
    interface DataModule<T extends AttributeCollectionBase> {
		...
		*/
        addOnLoad(myFunction: (context?: ExecutionContext<any>) => any): void;
    ...
    interface context {
		...
		*/
         ...
         */
        getCurrentAppProperties(): Promise<ApplicationProperties>;

        /**
         * URL of the current business app
         */
         ...
         * @returns A path string with the organization name prefixed in the following format: "/"+ orgName + sPath
         */
        prependOrgName(sPath: string): string;
    }

    /**
     * Interface describing the business application information
     */
    ...
    /**
     * Interface for working with the side panel
     */
    interface Panel {
        /**
    ...
    interface BaseControl {
         ...
         * On Dynamics 365 for Customer Engagement apps mobile clients, tapping on the icon will display the message, and let you perform the configured action by clicking the Apply button or dismiss the message.
         * @param notification The notification to add
         */
        addNotification(notification: NotificationObject): boolean;
    }
    ...
    interface NotificationObject {
         ...
         * The string that you specify here appears as bold text in the notification, and is typically used for title or subject of the notification.
...
interface XrmBase<T extends XrmBase.PageBase<XrmBase.AttributeCollectionBase, XrmBase.TabCollectionBase, XrmBase.ControlCollectionBase>> extends BaseXrm {
    Device: XrmBase.Device;
    Encoding: XrmBase.Encoding;
    Navigation: XrmBase.Navigation;
    Panel: XrmBase.Panel;
    WebApi: XrmBase.WebApi;
}
